...
mu1=mu12+mu13;mu2=-mu12;mu3=-mu13;
...
%u3=zeros(2,301);
for i=1:(10*tf+1);
u1(:,i)=-(tf-(i-1)/10)/r*(s1f-s2f-mu12+s1f-s3f-mu13)-1/r*(v1f-v2f+v1f-v3f);
...
for i=1:(10*tf+1);
u1h(:,i)=-(tf-(i-1)/10)/r*(hs1f-hs2f-mu12+hs1f-hs3f-mu13)-1/r*(hv1f-hv2f+hv1f-hv3f);
...
[th1,P1]=ode45(@(t,x) ControlUndirected(t,x,hs1f,hs2f,hs3f,hv1f,hv2f,hv3f,mu12,mu13,tf,r), ...
    [0 tf],[x1' x2' x3']);
...
[th,P]=ode45(@(t,x) ControlUndirected(t,x,s1f,s2f,s3f,v1f,v2f,v3f,mu12,mu13,tf,r), ...
    [0 tf],[x1' x2' x3']);
% 
...
i1=size(th1,1);
p3=plot(P1(:,1),P1(:,2),'+b','LineWidth',2);hold
plot(P1(:,5),P1(:,6),'+b','LineWidth',2);
plot(P1(:,9),P1(:,10),'+b','LineWidth',2);
